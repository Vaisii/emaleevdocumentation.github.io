...
<div class="page">
  <header>
    <div class="avatar"><img src="images/photo.jpg" alt="Фотография" width = 84px heigh = 84px border-radius = 8px;> </div>
    <div>
  ...
  <!-- <div class="layout">
    <aside class="card">
      ...
      <div class="section">
        <h2>I made this page to showcase some samples of the texts that I have written.</h2> 
        <!-- <p>It is written in HTML and hosted on GitHub Pages.</p>   -->
      </div>
      ...
      <div class="section">
        <h2>Languages</h2>
        <ul><li>English — Fluent</li><li>Russian — Native</li><li>German — Intermediate</li></ul>
      </div>
       ...
       <details class="details-cv" id="cv-details" open>
          ...
          <div class="cv-sections">
            <section class="card section">
              ...
              <a href="managerial.html" >Texts that I have written in English on the topics of management and corporate governance</a>
